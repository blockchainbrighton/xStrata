...
- `CONTRACT_SOURCE_BATCHXR_V9_2_11` (~9.6 KB)
...
- legacy, batch, batchx, batchxr, batchxrv3, batchxrv9, batchxrv9-2, batchxrv9-2-2, batchxrv9-2-3, batchxrv9-2-5, batchxrv9-2-6, batchxrv9-2-7, batchxrv9-2-8, batchxrv9-2-9, batchxrv9-2-10, batchxrv9-2-11

Note: v9.2 / v9.2.2 / v9.2.3 / v9.2.5 / v9.2.6 / v9.2.7 / v9.2.8 / v9.2.9 / v9.2.10 / v9.2.11 use a sequential hash in `assets/core/index.js`.
...
Note: v9.2.11 stores token URIs per-id and defaults to a URL during sealing in the app.
