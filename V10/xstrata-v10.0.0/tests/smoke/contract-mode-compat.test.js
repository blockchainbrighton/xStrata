  ...
  },
  {
    ...
    run() {
      ...
      assert(
        ...
        html.includes("v9.2.8") &&
        html.includes("v9.2.9") &&
        html.includes("v9.2.10") &&
        html.includes("v9.2.11"),
        "Expected UI to mention v9.2.2, v9.2.3, v9.2.5, v9.2.6, v9.2.7, v9.2.8, v9.2.9, v9.2.10, and v9.2.11"
      );
      assert(
