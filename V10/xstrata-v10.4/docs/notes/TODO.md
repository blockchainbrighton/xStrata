...
NOTE: Historical file references in this doc point to `assets/index-06f51251-2.js`.
In this repo, the runtime bundle is `assets/core/index.js`. Use
`docs/maps/core-index.md` for anchors and line lookups.
