...
### 3. Smart Contract
*   **File:** `contracts/u64bxr-v5.clar`
*   **Name:** `u64bxr-v5` (Batch XR Version 5)
*   **Status:** **OPTIMIZED**.
...
Notes for transfer to mainnet

1-Must update royalty addresses

2-The contract is currently configured to use the Testnet NFT trait
  definition (ST00...). If you deploy to Mainnet, you must update the trait
  reference in contracts/u64bxr-v5.clar to the Mainnet address (SP2...) before
  building/deploying, otherwise the deployment will fail. The GEMINI.md
  context file notes this requirement.